...
echo "═══════════════════════════════════════════════════════"
echo "  Hotel Reservation System - Container Startup (REST API)"
echo "═══════════════════════════════════════════════════════"
echo ""
...
echo ""
echo "Access URLs (Host):"
echo "  Web Application:  http://localhost:8080/HotelReservation-war/"
echo "  REST API:         http://localhost:8080/HotelReservation-war/api/rooms"
echo "  Admin Console:    http://localhost:4850"
echo "  MySQL:            localhost:3308 (root/root)"
echo ""
